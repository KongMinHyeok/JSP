	...
	$(function(){
		...
		$.get('/Farmstory/board/proc/getLatest.jsp?cate=notice', function(data){			
			...
			for(let latest of data){
				let url = "/Farmstory/board/view.jsp?group=community&cate=notice&pg=1&no="+latest.no;
		...
		$.get('/Farmstory/board/proc/getLatest.jsp?cate=qna', function(data){			
			...
			for(let latest of data){
				let url = "/Farmstory/board/view.jsp?group=community&cate=qna&pg=1&no="+latest.no;
		...
		$.get('/Farmstory/board/proc/getLatest.jsp?cate=faq', function(data){			
			...
			for(let latest of data){
				let url = "/Farmstory/board/view.jsp?group=community&cate=faq&pg=1&no="+latest.no;
    ...
    <div class="latest">
        <div>
            ...
            <table border="0">
                ...
                <tr>
                    <td>></td>
                    <td><a href="/Farmstory/board/view.jsp?group=croptalk&cate=grow&pg=1&no=<%= lt.getNo() %>"><%= lt.getTitle() %></a></td>
                    <td><%= lt.getRdate() %></td>
                </tr>
                <% } %>
            </table>
        ...
        <div>
            ...
            <table border="0">
                ...
                <tr>
                    <td>></td>
                    <td><a href="/Farmstory/board/view.jsp?group=croptalk&cate=school&pg=1&no=<%= lt.getNo() %>"><%= lt.getTitle() %></a></td>
                    <td><%= lt.getRdate() %></td>
                </tr>
                <% } %>
            </table>
        ...
        <div>
            ...
            <table border="0">
                ...
                <tr>
                    <td>></td>
                    <td><a href="/Farmstory/board/view.jsp?group=croptalk&cate=story&pg=1&no=<%= lt.getNo() %>"><%= lt.getTitle() %></a></td>
                    <td><%= lt.getRdate() %></td>
                </tr>
                <% } %>
            </table>
