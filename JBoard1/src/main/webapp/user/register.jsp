...
<main id="user" class="register">
	<form action="/JBoard1/user/proc/registerProc.jsp" method="post">
		<table border="1">
			...
			<tr>
				...
				<td><input type="text" name="uid" placeholder="아이디 입력" />
					...
					<img src="/JBoard1/img/chk_id.gif" alt="중복확인" /></button>
		...
		<table border="1">
			...
			<tr>
				<th>주소</th>
				<td><input type="text" name="zip" id="zip" placeholder="우편번호 검색" readonly />
					...
					<input type="text" name="addr2" id="addr2" placeholder="상세주소 입력" /></td>
			</tr>
		</table>
