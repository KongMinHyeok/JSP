...
<main id="board" class="view">
	...
	<div>
		<a href="#" class="btn btnRemove">삭제</a> <a href="/JBoard1/modify.jsp"
			class="btn btnModify">수정</a> <a href="/JBoard1/list.jsp"
	...
	<section class="commentList">
		<h3>댓글목록</h3>
		<article>
			<span class="nick">공민혁</span> <span class="date">20-05-13</span>
		...
		<form action="#">
			...
			<div>
				<a href="." class="btn btnCancel">취소</a> <input type="submit"
					class="btn btnComplete" value="작성완료">
			</div>
		</form>
	</section>
</main>
